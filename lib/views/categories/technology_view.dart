...
import 'package:ozet_haber/services/categories/technology_service.dart';
...
class _TechnologyViewState extends State<TechnologyView> {
  final TechnologyService _technologyService = TechnologyService(); 
  late Future<List<NewsModel>> _articlesFuture;

  @override
  void initState() {
    super.initState();
    _articlesFuture = _technologyService.fetchArticles(); 
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: AppBarTitle(TitlesConst.technologyViewTitle),
          centerTitle: true,
        ),
        drawer: DrawerMenu(),
